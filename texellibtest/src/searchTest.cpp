...
#include "cute.h"
    ...
    public void testNegaScout() throws ChessParseError, StopSearch {
        ...
        ASSERT(Math.abs(score) < 50);   // Stale-mate trap
        score2 = idSearch(sc, 5).score;
        ASSERT_EQUAL(score, score2);
        ...
        ASSERT(!TextIO::moveToString(pos, bestM, false).equals("Qxb3"));
    }
    ...
    public void testHashing() throws ChessParseError {
        ...
        ASSERT_EQUAL(TextIO::stringToMove(pos, "Kb1"), new Move(bestM));
    }
    ...
    public void testCheckEvasion() throws ChessParseError {
        ...
        sc = new Search(pos, nullHist, 0, tt);
        bestM = idSearch(sc, 1);
        ASSERT_EQUAL(Search.MATE0 - 4, bestM.score);
        ASSERT_EQUAL(TextIO::stringToMove(pos, "Qxh7+"), new Move(bestM));
    }
    ...
    public void testSEE() throws ChessParseError {
        ...
        //  1 99
        //-98 99
        ASSERT_EQUAL(pV - kV, getSEE(sc, new Move(TextIO::getSquare("e5"), TextIO::getSquare("e4"), Piece::EMPTY)));
        ...
        pos.setWhiteMove(false);
        sc = new Search(pos, nullHist, 0, tt);
        ASSERT_EQUAL(kV, getSEE(sc, new Move(TextIO::getSquare("a4"), TextIO::getSquare("c4"), Piece::EMPTY)));
