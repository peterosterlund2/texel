...
DECLARE_PARAM(trappedRookPenalty,    68, 0, 200, useUciParam);
...
DECLARE_PARAM(kingSafetyWeight1,         35, -50, 200, useUciParam);
...
DECLARE_PARAM(queenLoMtrl,         4494, 0, 10000, useUciParam);
