...
DECLARE_PARAM(pawnRaceBonus,          159, 0, 1000, useUciParam);

DECLARE_PARAM(QvsRMBonus1,         14, -100, 100, useUciParam);
...
DECLARE_PARAM(trappedRookPenalty,    60, 0, 200, useUciParam);
