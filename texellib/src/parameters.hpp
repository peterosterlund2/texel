...
DECLARE_PARAM(QvsRMBonus1,         19, -100, 100, useUciParam);
DECLARE_PARAM(QvsRMBonus2,         17, -100, 100, useUciParam);
...
DECLARE_PARAM(pawnHiMtrl,          3207, 0, 10000, useUciParam);
...
DECLARE_PARAM(queenLoMtrl,         4489, 0, 10000, useUciParam);
