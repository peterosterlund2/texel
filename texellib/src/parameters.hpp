...
DECLARE_PARAM(pawnSemiBackwardPenalty1, 10, -50, 50, useUciParam);
DECLARE_PARAM(pawnSemiBackwardPenalty2, 3, -50, 50, useUciParam);
DECLARE_PARAM(pawnRaceBonus,            161, 0, 1000, useUciParam);
...
DECLARE_PARAM(activePawnPenalty,         5, -50, 50, useUciParam);

DECLARE_PARAM(QvsRMBonus1,         40, -100, 100, useUciParam);
DECLARE_PARAM(QvsRMBonus2,         -10, -100, 100, useUciParam);
...
DECLARE_PARAM(krkpBonus,           153, 0, 400, useUciParam);
DECLARE_PARAM(krpkbBonus,          140, -200, 200, useUciParam);
DECLARE_PARAM(krpkbPenalty,        67,  0, 128, useUciParam);
DECLARE_PARAM(krpknBonus,          229, 0, 400, useUciParam);
...
DECLARE_PARAM(pieceTradeThreshold, 705, 10, 1000, useUciParam);
...
DECLARE_PARAM(rookDouble7thRowBonus, 87, 0, 100, useUciParam);
DECLARE_PARAM(trappedRookPenalty1,   73, 0, 200, useUciParam);
DECLARE_PARAM(trappedRookPenalty2,   44, 0, 200, useUciParam);

DECLARE_PARAM(bishopPairPawnPenalty, 5, 0, 10, useUciParam);
DECLARE_PARAM(trappedBishopPenalty,  123, 0, 300, useUciParam);
DECLARE_PARAM(oppoBishopPenalty,     82, 0, 128, useUciParam);
...
DECLARE_PARAM(kingSafetyWeight3,         3, -50, 200, useUciParam);
...
DECLARE_PARAM(queenLoMtrl,         4546, 0, 10000, useUciParam);
DECLARE_PARAM(queenHiMtrl,         6580, 0, 10000, useUciParam);
...
DECLARE_PARAM(knightOutpostLoMtrl, 307, 0, 10000, useUciParam);
DECLARE_PARAM(knightOutpostHiMtrl, 1079, 0, 10000, useUciParam);
