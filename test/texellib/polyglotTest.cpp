...
TEST(PolyglotTest, testMove) {
    ...
    EXPECT_EQ((6 << 0) | (0 << 3) | (4 << 6) | (0 << 9) | (0 << 12),
              getPGMove(pos, TextIO::uciStringToMove("e1g1")));
    EXPECT_EQ((2 << 0) | (0 << 3) | (4 << 6) | (0 << 9) | (0 << 12),
              getPGMove(pos, TextIO::uciStringToMove("e1c1")));
    EXPECT_EQ((6 << 0) | (7 << 3) | (4 << 6) | (7 << 9) | (0 << 12),
              getPGMove(pos, TextIO::uciStringToMove("e8g8")));
    EXPECT_EQ((2 << 0) | (7 << 3) | (4 << 6) | (7 << 9) | (0 << 12),
              getPGMove(pos, TextIO::uciStringToMove("e8c8")));

    // Promotion
    pos = TextIO::readFEN("r3q2r/pPp1kppp/2npbn2/2b1p3/2B1P3/2NP1N2/PpPBKPPP/R3Q2R w - - 0 1");
    EXPECT_EQ((0 << 0) | (7 << 3) | (1 << 6) | (6 << 9) | (1 << 12),
              getPGMove(pos, TextIO::uciStringToMove("b7a8n")));
    EXPECT_EQ((0 << 0) | (7 << 3) | (1 << 6) | (6 << 9) | (2 << 12),
              getPGMove(pos, TextIO::uciStringToMove("b7a8b")));
    EXPECT_EQ((0 << 0) | (7 << 3) | (1 << 6) | (6 << 9) | (3 << 12),
              getPGMove(pos, TextIO::uciStringToMove("b7a8r")));
    EXPECT_EQ((0 << 0) | (7 << 3) | (1 << 6) | (6 << 9) | (4 << 12),
...
TEST(PolyglotTest, testSerialize) {
    ...
    EXPECT_EQ(0x123456789abcdef0ULL, hash);
    EXPECT_EQ(53000, move);
    EXPECT_EQ(61000, weight);
}
